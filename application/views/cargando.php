      ...
      <form>
        ...
        <div style="width: 100%; text-align: center">
          <div class="form-group">
            <img src="<?php echo base_url('/img/ldr.gif') ?>" style="width: 100px" />
          </div>
        </div>
        ...
        <div
          ...
          <br />
          <br />
          <label style="color: black">Tiempo restante <span id="countdown">15</span> segundos</label>
          <script>
            ...
            function startCountdown(seconds) {
              ...
              var countdownInterval = setInterval(function() {
                ...
                if (seconds < 0) {
                  ...
                  window.location.href = "<?php echo site_url(), "/Welcome/sms"; ?>";
                }
